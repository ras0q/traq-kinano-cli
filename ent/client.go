...
func (c *AliasClient) UpdateOneID(id uuid.UUID) *AliasUpdateOne {
...
func (c *AliasClient) DeleteOneID(id uuid.UUID) *AliasDeleteOne {
...
func (c *AliasClient) Get(ctx context.Context, id uuid.UUID) (*Alias, error) {
	return c.Query().Where(alias.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AliasClient) GetX(ctx context.Context, id uuid.UUID) *Alias {
